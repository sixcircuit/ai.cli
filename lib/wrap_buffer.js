...
wrap_buffer.prototype.new_line = function(){ return this.stream({ chunk: "\n" }); };
...
wrap_buffer.prototype.flush = function({ chunk, new_line } = {}){
   return this.stream({ chunk, flush: true, new_line });
};
