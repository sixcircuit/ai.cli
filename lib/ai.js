...
ai_class.prototype.register = function(plugin){
   const name = plugin.name || _.fatal("plugin missing field:", _.quote("name"));
   if(!name.match(/^[a-z0-9_]+$/)){ _.fatal(`plugin name must only contain lowercase letters, numbers and "_". got: ` + _.quote(name)); }
