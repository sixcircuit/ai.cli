...
lib.system = function({ short, messages, request }){
   ...
   sys.push("When showing code, minimise vertical space, do not add any comments or docstrings, and use 3 spaces where tabs would go, and always use snake_case. Preserve any comments in any code provided and convert code in comments if necessary.")
